...
4a. **Per-corpus RAG completeness (verified 2026-07-22, content-level, not just file-existence)**:
   ...
   | Corpus | Live index docs | Status |
   |---|---|---|
   | Bhagavad Gita | 701 | Strong — all 18 chapters |
   | Upanishads | 45 | Registered, thin (~4 verses/text — curated highlights, not full text) |
   | Sikh Gurbani | 34 | **Complete** — Japji Sahib + Anand Sahib + Rehras Sahib all present, `public_domain`. (An earlier pass of this audit incorrectly flagged these as unwired; that was based on reading the retriever's registered filename config, not the actual index contents.) |
   | Jain Dharma | 107 | **Complete** — base corpus + Kalpa Sutra + Tattvartha Sutra all present. (Same correction as above.) |
