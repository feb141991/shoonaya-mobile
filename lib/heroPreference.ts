...
export const LOCAL_HERO_ASSETS: Record<string, any> = {
  ...
  'onam-kerala-dawn': require('@/assets/heroes/hindu/onam-kerala-dawn.webp'),
  'vivah-panchami-mandap': require('@/assets/heroes/hindu/vivah-panchami-mandap.webp'),
  'vaikunta-ekadashi-dvaram': require('@/assets/heroes/hindu/vaikunta-ekadashi-dvaram.webp'),
  'anant-chaturdashi-shesha': require('@/assets/heroes/hindu/anant-chaturdashi-shesha.webp'),
  'dev-deepawali-varanasi': require('@/assets/heroes/hindu/dev-deepawali-varanasi.webp'),
  'chintpurni-devi-shrine': require('@/assets/heroes/hindu/chintpurni-devi-shrine.webp'),
  'vat-savitri-banyan': require('@/assets/heroes/hindu/vat-savitri-banyan.webp'),
  'pradosh-vrat-shiva': require('@/assets/heroes/hindu/pradosh-vrat-shiva.webp'),
  'shaiva-default': require('@/assets/heroes/hindu/shiva-default.webp'),
  'maha-shivaratri': require('@/assets/heroes/hindu/mahashivratri.webp'),
  'sikh-guru-amar-das': require('@/assets/heroes/sikh/sikh-guru-amar-das-ji.webp'),
  'sikh-guru-amar-das-ji': require('@/assets/heroes/sikh/sikh-guru-amar-das-ji.webp'),
  'sikh-guru-ram-das': require('@/assets/heroes/sikh/sikh-guru-ram-das-ji.webp'),
  'sikh-guru-ram-das-ji': require('@/assets/heroes/sikh/sikh-guru-ram-das-ji.webp'),
  'sikh-guru-har-krishan': require('@/assets/heroes/sikh/sikh-guru-har-krishan-ji.webp'),
  'sikh-guru-har-krishan-ji': require('@/assets/heroes/sikh/sikh-guru-har-krishan-ji.webp'),
...
export const BUNDLED_HERO_THEMES: Array<{
  ...
  {
    id: 'onam-kerala-dawn',
    label: 'Onam Kerala Dawn Sanctuary',
    heroImage: '/assets/images/heroes/hindu/onam-kerala-dawn.webp',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
  },
  {
    id: 'vivah-panchami-mandap',
    label: 'Vivah Panchami Sacred Mandap',
    heroImage: '/assets/images/heroes/hindu/vivah-panchami-mandap.webp',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
  },
  {
    id: 'vaikunta-ekadashi-dvaram',
    label: 'Vaikunta Ekadashi Golden Dvaram',
    heroImage: '/assets/images/heroes/hindu/vaikunta-ekadashi-dvaram.webp',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
  },
  {
    id: 'anant-chaturdashi-shesha',
    label: 'Anant Chaturdashi Cosmic Shesha',
    heroImage: '/assets/images/heroes/hindu/anant-chaturdashi-shesha.webp',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
  },
  {
    id: 'dev-deepawali-varanasi',
    label: 'Dev Deepawali Varanasi Ghats',
    heroImage: '/assets/images/heroes/hindu/dev-deepawali-varanasi.webp',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
  },
  {
    id: 'chintpurni-devi-shrine',
    label: 'Chintpurni Mata Himalayan Shrine',
    heroImage: '/assets/images/heroes/hindu/chintpurni-devi-shrine.webp',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
  },
  {
    id: 'vat-savitri-banyan',
    label: 'Vat Savitri Sacred Banyan',
    heroImage: '/assets/images/heroes/hindu/vat-savitri-banyan.webp',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
  },
  {
    id: 'pradosh-vrat-shiva',
    label: 'Pradosh Vrat Sandhya Shiva',
    heroImage: '/assets/images/heroes/hindu/pradosh-vrat-shiva.webp',
    objectPosition: '50% 25%',
    traditions: ['hindu'],
  },
  {
