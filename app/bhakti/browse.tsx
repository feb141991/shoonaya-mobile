...
export default function BrowseScreen() {
  ...
  return (
    <Screen style={{ backgroundColor: theme.bg, paddingHorizontal: 0, paddingVertical: 0 }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 60, gap: 18 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ marginHorizontal: 20, borderRadius: RADII.lg, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.card, padding: 16, gap: 14 }}>
        ...
        <View style={{ paddingHorizontal: 20, gap: 12 }}>
          <Text style={{ ...TYPE.caption, color: theme.dim }}>{filtered.length} track{filtered.length !== 1 ? 's' : ''}</Text>
