...
import { ActivityIndicator, Alert, Modal, ScrollView, Text, TextInput, useColorScheme, View } from 'react-native';
    ...
    <Screen style={{ backgroundColor: theme.bg }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 28, gap: 14 }}>
        <View style={{ flexDirection: 'row', backgroundColor: theme.card, borderRadius: 12, padding: 4, marginHorizontal: 16, marginTop: 16 }}>
          <PressableSurface haptic="selection" onPress={() => router.back()} accessibilityLabel="Switch to Local Feed" style={{ flex: 1, paddingVertical: 8, alignItems: 'center', borderRadius: 8 }}>
        ...
        <PressableSurface haptic="selection" onPress={() => router.back()} style={{ flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 16, minHeight: 0 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16 }}>
          ...
          <PressableSurface haptic="selection" onPress={() => setSheetVisible(true)} style={{ borderRadius: 18, backgroundColor: theme.brand, paddingHorizontal: 14, paddingVertical: 10 }}>
            ...
            return (
              ...
              >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 14, marginTop: 4 }}>
                  ...
                  <PressableSurface haptic="selection" onPress={() => void toggleUpvote(thread.id)} style={{ flexDirection: 'row', alignItems: 'center', gap: 4, minHeight: 0 }}>
        ...
        <View style={{ flex: 1, backgroundColor: COLORS.celebrationScrim, justifyContent: 'flex-end' }}>
          <ScrollView style={{ backgroundColor: theme.card, borderTopLeftRadius: 28, borderTopRightRadius: 28, maxHeight: '88%' }} contentContainerStyle={{ padding: 20, gap: 14 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 10 }}>
              <PressableSurface haptic="selection" onPress={() => setSheetVisible(false)} style={{ flex: 1, borderRadius: 16, borderWidth: 1, borderColor: theme.border, paddingVertical: 14, alignItems: 'center' }}>
